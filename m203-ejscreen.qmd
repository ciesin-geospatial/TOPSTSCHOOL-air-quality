...
![](docs/m203-ej-images/image9.png)Once you click the link, you'll be directed to a Welcome screen. Here, you'll find an introduction, resource links, and a video overview of the tool. We recommend exploring these resources before proceeding. After that, close the Welcome dialog to continue.
...
![]()![](docs/m203-ej-images/image15.png)
