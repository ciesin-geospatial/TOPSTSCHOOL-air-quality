...
```{python}
df_detroit = pd.read_csv(r'C:\Users\efamutim\Downloads\ejscreen\ejscreen_detroit.csv', header = 1)
```
...
df_sterlingheights = pd.read_csv(r'C:\Users\efamutim\Downloads\ejscreen\ejscreen_sterlingheights.csv', header = 1)
