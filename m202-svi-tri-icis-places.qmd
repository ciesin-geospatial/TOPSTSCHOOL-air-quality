---
title: "Exploring SVI, TRI, and Health Outcomes in Metro Detroit"
...
plt.title('Histogram of 2023 Air Total Release Sum')
plt.xlabel('Air Sum')
...
plt.title('Histogram of the Log of 2023 Air Total Release Sum')
...
plt.title("Detroit Metro Area TRI Facilities - 2023 Total Air Releases (Custom Data)", fontsize=16)
plt.tight_layout()
plt.show()
...
plt.title('IDW Interpolated Asthma Prevalence in Detroit Metro Area 2023', fontsize=16)
ax.axis('off')
