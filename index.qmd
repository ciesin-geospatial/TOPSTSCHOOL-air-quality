...
-   **Acquiring, Pre-Processing, and Visualizing Student-Monitored Data for New York City schools:** This lesson will emphasize the relationship between hazardous air quality, extreme temperatures, and socioeconomic characteristics of different New York City school environments.
...
-  **Exploring Air Quality, Social Vulnerability, and Health Outcomes in Metro Detroit:** Participants will investigate how the SVI highlights areas at greater risk for adverse health outcomes due to environmental hazards. This lesson will examine the connections between socioeconomic status, health disparities, and environmental injustice.
...
-   **Examining the Environmental Justice Screening and Mapping Tool (EJScreen)** to analyze the environmental and demographic characteristics of specific areas. Students will learn to use EJScreen to identify regions disproportionately affected by pollution and to assess the intersection of environmental hazards with community demographics. This lesson will focus on how data can empower communities in advocating for their rights.
    -   [Lesson 3: Examining the Environmental Justice Screening and Mapping Tool (EJScreen)](https://ciesin-geospatial.github.io/TOPSTSCHOOL-air-quality/m203-ejscreen.html)
