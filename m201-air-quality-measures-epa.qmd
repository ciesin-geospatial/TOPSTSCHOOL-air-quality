...
The EPA AirData Air Quality Monitors data is available to download here: <https://epa.maps.arcgis.com/apps/webappviewer/index.html?id=5f239fd3e72f424f98ef3d5def547eb5>
...
Now you can see the PM2.5 sensor locations in the South Bronx. Click on one of the sensor locations on the map to see the pop-up appear. The pop-up window allows you to see data about the sensor site, including the sample collection frequency and analysis method, and download the available data.
