...
In this lesson, you will learn about how the wildfire in Palisades, New Jersey in November of 2024 negatively impacted the air quality in the surrounding area, including New York City. You will learn how to download air quality data from PurpleAire and QuantAQ, and analyze the data to understand the effects of the wild fire on air quality measures like NO and CO. 
...
| Name                      | Aerodynamic Diameter       | Abbreviation |
|---------------------------|----------------------------|--------------|
| Coarse Particles          | 2.5μm <= x < 10μm         | PM<sub>10</sub> |
| Fine Particles            | 0.01μm <= x < 2.5μm       | PM<sub>2.5</sub> |
| Ultra Fine Particles (UFP)| x < 0.01μm                | PM<sub>0.1</sub> |
