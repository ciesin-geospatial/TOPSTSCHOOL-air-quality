...
<table>
  <tr>
    ...
    <th rowspan="2">Averaging Time</th>
    <th colspan="4">Interim Target</th>
    <th rowspan="2">AQG Level</th>
  </tr>
  <tr>
    <th>1</th>
    <th>2</th>
...
for index, row in country_sample.iloc[:].iterrows():
    ...
    grdi_country_zs= rasterstats.zonal_stats(country_poly, grdi_raster.values[0], affine=grdi_raster.rio.transform(), stats="min mean max percentile_20 percentile_40 percentile_60 percentile_80")
    pm25_country_zs= rasterstats.zonal_stats(country_poly, pm25_raster.values[0], affine=pm25_raster.rio.transform(), stats="mean")
